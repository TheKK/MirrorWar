...
public final class UpdateOuterClass {
  ...
  public interface UpdateOrBuilder extends
      // @@protoc_insertion_point(interface_extends:mirrorWar.update.Update)
      com.google.protobuf.MessageOrBuilder {

    /**
     * <code>optional .mirrorWar.player.PlayerState player_state = 1;</code>
     */
    ...
    /**
     * <code>optional .mirrorWar.mirror.MirrorState mirror_state = 2;</code>
     */
    ...
    /**
     * <code>optional .mirrorWar.charger.ChargerState charger_state = 3;</code>
     */
    ...
    public mirrorWar.update.UpdateOuterClass.Update.UpdateCase getUpdateCase();
  }
  /**
   * Protobuf type {@code mirrorWar.update.Update}
   */
  public  static final class Update extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:mirrorWar.update.Update)
      UpdateOrBuilder {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              ...
              update_ =
                  input.readMessage(mirrorWar.gameReport.GameReport.Status.PARSER, extensionRegistry);
              if (subBuilder != null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return mirrorWar.update.UpdateOuterClass.internal_static_mirrorWar_update_Update_descriptor;
    }

    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return mirrorWar.update.UpdateOuterClass.internal_static_mirrorWar_update_Update_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              mirrorWar.update.UpdateOuterClass.Update.class, mirrorWar.update.UpdateOuterClass.Update.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof mirrorWar.update.UpdateOuterClass.Update)) {
        return super.equals(obj);
      }
      mirrorWar.update.UpdateOuterClass.Update other = (mirrorWar.update.UpdateOuterClass.Update) obj;
    ...
    public static mirrorWar.update.UpdateOuterClass.Update parseFrom(
    ...
    public static mirrorWar.update.UpdateOuterClass.Update parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static mirrorWar.update.UpdateOuterClass.Update parseFrom(
    ...
    public static mirrorWar.update.UpdateOuterClass.Update parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static mirrorWar.update.UpdateOuterClass.Update parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static mirrorWar.update.UpdateOuterClass.Update parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(mirrorWar.update.UpdateOuterClass.Update prototype) {
    ...
    public static final class Builder extends
        ...
        // @@protoc_insertion_point(builder_implements:mirrorWar.update.Update)
        mirrorWar.update.UpdateOuterClass.UpdateOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return mirrorWar.update.UpdateOuterClass.internal_static_mirrorWar_update_Update_descriptor;
      }
      ...
      // Construct using mirrorWar.update.UpdateOuterClass.Update.newBuilder()
      private Builder() {
      ...
      public mirrorWar.update.UpdateOuterClass.Update getDefaultInstanceForType() {
        return mirrorWar.update.UpdateOuterClass.Update.getDefaultInstance();
      }

      public mirrorWar.update.UpdateOuterClass.Update build() {
        mirrorWar.update.UpdateOuterClass.Update result = buildPartial();
      ...
      public mirrorWar.update.UpdateOuterClass.Update buildPartial() {
        mirrorWar.update.UpdateOuterClass.Update result = new mirrorWar.update.UpdateOuterClass.Update(this);
        ...
        if (updateCase_ == 4) {
          if (gameReportStateBuilder_ == null) {
            ...
            result.update_ = gameReportStateBuilder_.build();
          }
        }
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof mirrorWar.update.UpdateOuterClass.Update) {
          return mergeFrom((mirrorWar.update.UpdateOuterClass.Update)other);
        } else {
      ...
      public Builder mergeFrom(mirrorWar.update.UpdateOuterClass.Update other) {
        if (other == mirrorWar.update.UpdateOuterClass.Update.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        mirrorWar.update.UpdateOuterClass.Update parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (mirrorWar.update.UpdateOuterClass.Update) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
        ...
        if (gameReportStateBuilder_ == null) {
          ...
          gameReportStateBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              mirrorWar.gameReport.GameReport.Status, mirrorWar.gameReport.GameReport.Status.Builder, mirrorWar.gameReport.GameReport.StatusOrBuilder>(
                  (mirrorWar.gameReport.GameReport.Status) update_,
                  getParentForChildren(),
                  isClean());
          update_ = null;
        }
      ...
      // @@protoc_insertion_point(builder_scope:mirrorWar.update.Update)
    }

    // @@protoc_insertion_point(class_scope:mirrorWar.update.Update)
    private static final mirrorWar.update.UpdateOuterClass.Update DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new mirrorWar.update.UpdateOuterClass.Update();
    }

    public static mirrorWar.update.UpdateOuterClass.Update getDefaultInstance() {
  ...
  public interface UpdatesOrBuilder extends
      // @@protoc_insertion_point(interface_extends:mirrorWar.update.Updates)
      com.google.protobuf.MessageOrBuilder {

    /**
     * <code>repeated .mirrorWar.update.Update updates = 1;</code>
     */
    java.util.List<mirrorWar.update.UpdateOuterClass.Update> 
        getUpdatesList();
    /**
     * <code>repeated .mirrorWar.update.Update updates = 1;</code>
     */
    mirrorWar.update.UpdateOuterClass.Update getUpdates(int index);
    /**
     * <code>repeated .mirrorWar.update.Update updates = 1;</code>
     */
    int getUpdatesCount();
     ...
     * <code>repeated .mirrorWar.update.Update updates = 1;</code>
     */
    java.util.List<? extends mirrorWar.update.UpdateOuterClass.UpdateOrBuilder> 
        getUpdatesOrBuilderList();
    /**
     * <code>repeated .mirrorWar.update.Update updates = 1;</code>
     */
    mirrorWar.update.UpdateOuterClass.UpdateOrBuilder getUpdatesOrBuilder(
        int index);
  }
  /**
   * Protobuf type {@code mirrorWar.update.Updates}
   */
  public  static final class Updates extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:mirrorWar.update.Updates)
      UpdatesOrBuilder {
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
                updates_ = new java.util.ArrayList<mirrorWar.update.UpdateOuterClass.Update>();
                mutable_bitField0_ |= 0x00000001;
              }
              updates_.add(
                  input.readMessage(mirrorWar.update.UpdateOuterClass.Update.PARSER, extensionRegistry));
              break;
            }
          }
        }
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return mirrorWar.update.UpdateOuterClass.internal_static_mirrorWar_update_Updates_descriptor;
    }

    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return mirrorWar.update.UpdateOuterClass.internal_static_mirrorWar_update_Updates_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              mirrorWar.update.UpdateOuterClass.Updates.class, mirrorWar.update.UpdateOuterClass.Updates.Builder.class);
    }

    public static final int UPDATES_FIELD_NUMBER = 1;
    private java.util.List<mirrorWar.update.UpdateOuterClass.Update> updates_;
    /**
     * <code>repeated .mirrorWar.update.Update updates = 1;</code>
     */
    public java.util.List<mirrorWar.update.UpdateOuterClass.Update> getUpdatesList() {
      return updates_;
    }
    /**
     * <code>repeated .mirrorWar.update.Update updates = 1;</code>
     */
    public java.util.List<? extends mirrorWar.update.UpdateOuterClass.UpdateOrBuilder> 
        getUpdatesOrBuilderList() {
      return updates_;
    }
    /**
     ...
     * <code>repeated .mirrorWar.update.Update updates = 1;</code>
     */
    public mirrorWar.update.UpdateOuterClass.Update getUpdates(int index) {
      return updates_.get(index);
    }
    /**
     * <code>repeated .mirrorWar.update.Update updates = 1;</code>
     */
    public mirrorWar.update.UpdateOuterClass.UpdateOrBuilder getUpdatesOrBuilder(
        int index) {
      return updates_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof mirrorWar.update.UpdateOuterClass.Updates)) {
        return super.equals(obj);
      }
      mirrorWar.update.UpdateOuterClass.Updates other = (mirrorWar.update.UpdateOuterClass.Updates) obj;
    ...
    public static mirrorWar.update.UpdateOuterClass.Updates parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static mirrorWar.update.UpdateOuterClass.Updates parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static mirrorWar.update.UpdateOuterClass.Updates parseFrom(
    ...
    public static mirrorWar.update.UpdateOuterClass.Updates parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static mirrorWar.update.UpdateOuterClass.Updates parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static mirrorWar.update.UpdateOuterClass.Updates parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(mirrorWar.update.UpdateOuterClass.Updates prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() {
      return this == DEFAULT_INSTANCE
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements
        // @@protoc_insertion_point(builder_implements:mirrorWar.update.Updates)
        mirrorWar.update.UpdateOuterClass.UpdatesOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return mirrorWar.update.UpdateOuterClass.internal_static_mirrorWar_update_Updates_descriptor;
      }
      ...
      // Construct using mirrorWar.update.UpdateOuterClass.Updates.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public mirrorWar.update.UpdateOuterClass.Updates getDefaultInstanceForType() {
        return mirrorWar.update.UpdateOuterClass.Updates.getDefaultInstance();
      }

      public mirrorWar.update.UpdateOuterClass.Updates build() {
        mirrorWar.update.UpdateOuterClass.Updates result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public mirrorWar.update.UpdateOuterClass.Updates buildPartial() {
        mirrorWar.update.UpdateOuterClass.Updates result = new mirrorWar.update.UpdateOuterClass.Updates(this);
        int from_bitField0_ = bitField0_;
        if (updatesBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof mirrorWar.update.UpdateOuterClass.Updates) {
          return mergeFrom((mirrorWar.update.UpdateOuterClass.Updates)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(mirrorWar.update.UpdateOuterClass.Updates other) {
        if (other == mirrorWar.update.UpdateOuterClass.Updates.getDefaultInstance()) return this;
        if (updatesBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        mirrorWar.update.UpdateOuterClass.Updates parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (mirrorWar.update.UpdateOuterClass.Updates) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      private void ensureUpdatesIsMutable() {
        if (!((bitField0_ & 0x00000001) == 0x00000001)) {
          updates_ = new java.util.ArrayList<mirrorWar.update.UpdateOuterClass.Update>(updates_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          mirrorWar.update.UpdateOuterClass.Update, mirrorWar.update.UpdateOuterClass.Update.Builder, mirrorWar.update.UpdateOuterClass.UpdateOrBuilder> updatesBuilder_;
      ...
      public Builder setUpdates(
          int index, mirrorWar.update.UpdateOuterClass.Update value) {
        if (updatesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setUpdates(
          int index, mirrorWar.update.UpdateOuterClass.Update.Builder builderForValue) {
        if (updatesBuilder_ == null) {
          ensureUpdatesIsMutable();
       ...
       * <code>repeated .mirrorWar.update.Update updates = 1;</code>
       */
      public Builder addUpdates(mirrorWar.update.UpdateOuterClass.Update value) {
        if (updatesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addUpdates(
          mirrorWar.update.UpdateOuterClass.Update.Builder builderForValue) {
        if (updatesBuilder_ == null) {
          ensureUpdatesIsMutable();
      ...
      public Builder addAllUpdates(
          java.lang.Iterable<? extends mirrorWar.update.UpdateOuterClass.Update> values) {
        if (updatesBuilder_ == null) {
          ensureUpdatesIsMutable();
       ...
       * <code>repeated .mirrorWar.update.Update updates = 1;</code>
       */
      public mirrorWar.update.UpdateOuterClass.Update.Builder getUpdatesBuilder(
          int index) {
       ...
       * <code>repeated .mirrorWar.update.Update updates = 1;</code>
       */
      public mirrorWar.update.UpdateOuterClass.Update.Builder addUpdatesBuilder() {
        return getUpdatesFieldBuilder().addBuilder(
            mirrorWar.update.UpdateOuterClass.Update.getDefaultInstance());
      }
      /**
       * <code>repeated .mirrorWar.update.Update updates = 1;</code>
       */
      public mirrorWar.update.UpdateOuterClass.Update.Builder addUpdatesBuilder(
          int index) {
        return getUpdatesFieldBuilder().addBuilder(
            index, mirrorWar.update.UpdateOuterClass.Update.getDefaultInstance());
      }
      /**
       * <code>repeated .mirrorWar.update.Update updates = 1;</code>
       */
      public java.util.List<mirrorWar.update.UpdateOuterClass.Update.Builder> 
           getUpdatesBuilderList() {
        return getUpdatesFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          mirrorWar.update.UpdateOuterClass.Update, mirrorWar.update.UpdateOuterClass.Update.Builder, mirrorWar.update.UpdateOuterClass.UpdateOrBuilder> 
          getUpdatesFieldBuilder() {
        if (updatesBuilder_ == null) {
      ...
      // @@protoc_insertion_point(builder_scope:mirrorWar.update.Updates)
    }

    // @@protoc_insertion_point(class_scope:mirrorWar.update.Updates)
    private static final mirrorWar.update.UpdateOuterClass.Updates DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new mirrorWar.update.UpdateOuterClass.Updates();
    }

    public static mirrorWar.update.UpdateOuterClass.Updates getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_mirrorWar_update_Update_fieldAccessorTable;
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_mirrorWar_update_Updates_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_mirrorWar_update_Updates_fieldAccessorTable;
